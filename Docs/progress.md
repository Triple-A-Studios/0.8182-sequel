...
| ~~No overseeing system (`GameManager` or similar) exists yet — nothing owns run/game state above the individual resource systems.~~ Done: `GameManager` (Pass 4, Milestone: Core systems refactor). | [Pass 1, Milestone: Obstacles, combos, recovery](current-state.md) | Refactor | Resolved (Pass 4, Milestone: Core systems refactor) |
