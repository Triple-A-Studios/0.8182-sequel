...
- **Now:** Milestone "Feel polish" (MVP phase, last one before MVP is considered done — see [plan.md](plan.md)) — 7 passes scoped, 1 landed. Redefined beyond the original camera/juice-only scope to fold in backlog #16, #17, #18 plus new menu/mobile-input work (developer decision, 2026-09-23).
