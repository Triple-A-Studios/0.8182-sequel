...
## Snapshot
- **Last landed:** Pass 2 — Uniform penalty wiring + tough-building mistimed-hit fix (`2c22213`). Milestone "Core systems refactor" (MVP phase), branch `milestone/core-systems-refactor`.
- **Now:** Pass 3 next — per-resource damage tuning.
